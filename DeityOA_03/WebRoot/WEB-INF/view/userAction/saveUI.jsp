...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="sys/userAction_%{id!=null?'edit':'add'}.action" id="myForm">
                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">所属部门</td>
                        <td>
                            ...
                            <s:select name="departmentId" list="treeList" listKey="id" listValue="name"
                            headerKey="0" headerValue="请选择部门" cssClass="SelectStyle"></s:select>
                        </td>
                    </tr>
                    <tr><td><s:hidden name="id" value="%{id}"/></td></tr>
                    <tr><td>登录名</td>
                        <td><s:textfield name="loginName" cssClass="InputStyle required {messages:{required:'请填写登录名'}}"/> *
							（登录名要唯一）
						</td>
                    </tr>
                    <tr><td>姓名</td>
                        <td><s:textfield name="name" cssClass="InputStyle required {messages:{required:'请填写姓名'}}"/> *</td>
                    </tr>
					<tr><td>性别</td>
                        <td>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						<td width="100">岗位</td>
                        <td><!-- <select name="roleIdList" multiple="multiple" size="10" class="SelectStyle">
                            ...
                            <s:select name="roleIdList" list="roleList" listKey="id" listValue="name"
