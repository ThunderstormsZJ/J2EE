...
<!--显示表单内容-->
<div id="MainArea">
<s:form action="replyAction_add" namespace="/co" cssStyle="margin:0px;padding:0px;">
	<div id="PageHead"></div>
	<center>
		...
		<div class="ItemBlockBorder">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
				<tr><td><s:hidden name="topicId"/></td></tr>
				<tr><td><s:hidden name="forumId"/></td></tr>
				<tr>
						...
						<table cellpadding="0" border="0" cellspacing="0">
							<tr>
								...
								<td width="50" style="border-bottom:0 solid #ffffff">
									<input type="radio" name="faceIoc" value="${num}" id="r_${num}"/>
									<label for="r_${num}"><img width="19" height="19" src="style/images/face/face${num}.gif" align="absmiddle" disabled="true"/></label>
								</td>
								</s:iterator>
							</tr>
						</table></div>
				...
				<tr height="240">
					...
					<td class="InputAreaBg"><div class="InputContent"><s:textarea name="content" cssStyle="height:100px;width:600px;"></s:textarea></div></td>
				</tr>
				<tr height="30">
