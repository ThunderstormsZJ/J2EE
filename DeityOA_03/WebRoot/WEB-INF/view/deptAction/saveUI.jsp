...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="sys/deptAction_%{id!=null?'edit':'add'}.action" id="myForm">
                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">上级部门</td>
                        <td>
                            ...
                            <s:select name="parentId" list="treeList" listKey="id" listValue="name"
                            headerKey="0" headerValue="请选择部门" cssClass="SelectStyle"></s:select>
                        </td>
                    </tr>
                    <tr><td><s:hidden name="id" value="%{id}"/></td></tr>
                    <tr><td>部门名称</td>
                        <td><s:textfield name="name" cssClass="InputStyle required {messages:{required:'请填写部门名'}}"/> *</td>
                    </tr>
                    <tr><td>职能说明</td>
