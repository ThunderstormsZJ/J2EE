...
public class AnchorTag extends AbstractClosingTag {
    ...
    public int doEndTag() throws JspException {
    	...
    	String priviledgeUrl = href;
    	if(priviledgeUrl!=null){
    		int pos = priviledgeUrl.indexOf(".");
    		if(pos>-1){
    			priviledgeUrl = priviledgeUrl.substring(0,pos);
    		}
    		if(user.hasPriviledgeByUrl(priviledgeUrl)){
    			return super.doEndTag();//有就正常执行
    		}else{
    			return this.EVAL_PAGE;//没有权限就隐藏
    		}
    	}else{
